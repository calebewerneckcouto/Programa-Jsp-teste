...
<body>
	...
	<form action="salvarUsuario" method="post" id="formUser" style="width:98%"
				...
				<table>
					<tr>
						...
						<td><input type="text" id="cep" name="cep" value=""
							onblur="consultarCep()" maxlength="9" value="${user.cep}" /></td>
					</tr>
					<tr>
						<td>Login:</td>
					...
					<tr>
						...
						<td><input type="text" id="nome" name="nome"
							value="${user.nome}" maxlength="50" placeholder="Informe o nome" /></td>
						<td>Cidade:</td>
...
<form method="post" action="servletPesquisa" style="width:98%">
	<ul class="form-style-1">
		<li>
			<table>
				<tr>
			...
			<c:forEach items="${usuarios}" var="user"  >
				<tr>
					...
					<c:if test="${user.fotoBase64Miniatura.isEmpty() == false}">
						<td><a
							href="salvarUsuario?acao=download&tipo=imagem&user=${user.id}"><img
								...
								alt="Imagem User" title="Clique para fazer Download"
								width="32px" height="32px" /> </a></td>
					</c:if>
					<c:if test="${user.fotoBase64Miniatura == null}">
						<td><img alt="Imagem User" src="resources/img/usuario.png"
					...
					<c:if test="${user.curriculoBase64.isEmpty() == false}">
						<td><a
							href="salvarUsuario?acao=download&tipo=curriculo&user=${user.id}"><img
								alt="Curriculo" title="Clique para fazer Download"
								src="resources/img/pdf.png" width="32px" height="32px"> </a></td>
					</c:if>
					...
					<td><a href="salvarUsuario?acao=editar&user=${user.id}"><img
							src="resources/img/editar.jpg" alt="Editar" title="Editar"
							width="32px" height="32px" /></a></td>
				</tr>
			</c:forEach>
		</table>
